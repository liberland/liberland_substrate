...
/// Either underlying data blob if it is at most 256 bytes, or a hash of it.
///
/// Can also be `None`.
#[derive(
	Clone, Eq, PartialEq, RuntimeDebug, MaxEncodedLen, Encode, Decode, TypeInfo,
)]
pub enum Data {
	/// No data here.
	None,
	/// The data is stored directly.
	Raw(BoundedVec<u8, ConstU32<256>>),
